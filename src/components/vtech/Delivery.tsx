    ...
    <>
      <style>{`
        ...
        .pillar-card::after {
          ...
          position: absolute;
          inset: 0;
          background: radial-gradient(ellipse at 50% 100%, rgba(192,57,43,0.1) 0%, transparent 70%);
          opacity: 0;
        ...
        /* Spec row dividers inside the right panel */
        .spec-row {
          display: flex;
        ...
        @media (max-width: 768px) {
          ...
          .dv-hero-inner { grid-template-columns: 1fr !important; }
        }
      `}</style>
      ...
      <div className="dv-section">
        ...
        >
          <div style={{
            ...
            background: "linear-gradient(135deg, transparent 40%, rgba(13,27,75,0.3) 100%)",
            borderLeft: "1px solid rgba(192,57,43,0.12)",
            pointerEvents: "none",
          }} />

          <div
            className="dv-hero-inner"
            style={{
          ...
          >
            ...
            <div>
              ...
              <h2 style={{
                ...
                DELIVERY.<br />
                <span style={{ color: "#c0392b" }}>VALUE.</span><br />
                PERFORMANCE.
              </h2>

              <div style={{
                height: 2, background: "#c0392b",
                margin: "1.75rem 0", width: "80%",
              }} />
            ...
            {/* Right — conveyor panel */}
            <div className="dv-hero-right" style={{ position: "relative" }}>
              <div style={{
                ...
                <div style={{ overflow: "hidden", borderRadius: 4, marginBottom: "1.5rem" }}>
                  <div style={{ position: "relative", height: 80, background: "#0a1540" }}>
                    ...
                    <div style={{ position: "absolute", top: "50%", transform: "translateY(-50%)", left: "20%", width: 36, height: 26, background: "#c0392b", borderRadius: 2, display: "flex", alignItems: "center", justifyContent: "center" }}>
                      <div style={{ width: 20, height: 2, background: "rgba(255,255,255,0.5)", borderRadius: 1 }} />
                    </div>
                    <div style={{ position: "absolute", top: "50%", transform: "translateY(-50%)", left: "55%", width: 44, height: 30, background: "rgba(192,57,43,0.75)", borderRadius: 2 }} />
                  </div>
                </div>
        ...
        >
          <div style={{ maxWidth: 1200, margin: "0 auto" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: "1.5rem" }}>
              {PILLARS.map((p) => (
                <div key={p.number} className="pillar-card">
